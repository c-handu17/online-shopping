"""
Django settings for online-shopping project.
...
ALLOWED_HOSTS = [
    "online-shopping-prod.apigateway.in",
    "online-shopping-alpha.apigateway.in",
    "online-shopping-beta.apigateway.in",
    "online-shopping-gamma.apigateway.in",
    "online-shopping-staging.apigateway.in",
    "127.0.0.1",
    "localhost"
]

ROOT_URLCONF = 'online-shopping.urls'

CSRF_COOKIE_SECURE = False

WSGI_APPLICATION = 'online-shopping.wsgi.application'
...
LOGGING = {
    ...
    'formatters': {
        ...
        'console': {
            'format': "[%(request_id)s] [online-shopping - "+os.environ.get("STAGE", "local")+
...
# ****************** App Source Config ******************
ONLINE_SHOPPING_SOURCE = "online-shopping-source"
